...
public class Console {
	...
	public static Date validarData() {
		try {
			String dataString = Console.readString("Informe a data (01/01/2020): ");
			...
			System.out.println("Data inválida, informe uma data válida (01/01/2020)");
			return null;
		}
	}
}
